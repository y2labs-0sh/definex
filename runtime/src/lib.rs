...
impl_runtime_apis! {
    ...
    impl p2p_rpc_runtime_api::P2PApi<Block, AssetId, Balance, BlockNumber, AccountId, Moment> for Runtime {
        ...
        fn get_loans(size: Option<u64>, offset: Option<u64>) -> Vec<p2p_primitives::P2PLoan<AssetId, Balance, BlockNumber, AccountId>> {
            PToP::get_loans(size, offset)
        }

        fn get_user_borrows(who: AccountId, size: Option<u64>, offset: Option<u64>) -> Vec<p2p_primitives::P2PBorrow<AssetId, Balance, BlockNumber, AccountId>> {
            PToP::get_user_borrows(who, size, offset)
        }

        fn get_available_borrows(size: Option<u64>, offset: Option<u64>) -> Vec<p2p_primitives::P2PBorrow<AssetId, Balance, BlockNumber, AccountId>> {
            PToP::get_available_borrows(size, offset)
        }

        fn get_available_loans(size: Option<u64>, offset: Option<u64>) -> Vec<p2p_primitives::P2PLoan<AssetId, Balance, BlockNumber, AccountId>> {
            PToP::get_available_loans(size, offset)
        }
