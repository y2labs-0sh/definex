...
pub mod constants {
    ...
    pub const RBTC_ASSET_ID: <TestRuntime as generic_asset::Trait>::AssetId = 1;
    pub const RSC1_ASSET_ID: <TestRuntime as generic_asset::Trait>::AssetId = 2;
    pub const RSC2_ASSET_ID: <TestRuntime as generic_asset::Trait>::AssetId = 3;
    pub const RSC3_ASSET_ID: <TestRuntime as generic_asset::Trait>::AssetId = 4;
    pub const RSC4_ASSET_ID: <TestRuntime as generic_asset::Trait>::AssetId = 5;
    pub const RSC5_ASSET_ID: <TestRuntime as generic_asset::Trait>::AssetId = 6;
    pub const SBTC_ASSET_ID: <TestRuntime as generic_asset::Trait>::AssetId = 7;
    pub const TBD_ASSET_ID: <TestRuntime as generic_asset::Trait>::AssetId = 8;
}
...
pub type BridgeTest = Module<TestRuntime>;
pub type SystemTest = system::Module<TestRuntime>;
pub type BalancesTest = balances::Module<TestRuntime>;
...
pub fn new_test_ext() -> runtime_io::TestExternalities {
    ...
    generic_asset::GenesisConfig::<TestRuntime> {
        next_asset_id: 9,
        staking_asset_id: 0,
        spending_asset_id: 0,
        assets: vec![],
    ...
    GenesisConfig::<TestRuntime> {
        ...
        asset_id: SBTC_ASSET_ID,
        admins: vec![(ROOT, super::Auth::All)],
        pending_withdraw_vault: DAVE,
    }
    .assimilate_storage(&mut t)
    .unwrap();
