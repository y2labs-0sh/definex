...
pub mod constants {
    ...
    pub const RIO_ASSET_ID: <TestRuntime as pallet_generic_asset::Trait>::AssetId = 8;
}
...
// type RioAssets = rio_assets::Module<TestRuntime>;
// impl_outer_dispatch! {
//     pub enum Call for TestRuntime where origin: Origin {
//         balances::Balances,
//         system::System,
//         sudo::Sudo,
//         rio_assets::RioAssets,
//     }
// }
...
construct_runtime!(
        ...
        RioSavingTest: rio_saving::{Module, Call, Storage, Config<T>, Event<T>},
		    Indices: indices,
		}
);
...
impl rio_assets::Trait for TestRuntime {
    type Event = ();
    type OnAssetMint = RioSavingTest;
    type OnAssetCreate = ();
    type OnAssetTransfer = RioSavingTest;
    type OnAssetBurn = RioSavingTest;
    type BeforeAssetMint = ();
    type BeforeAssetCreate = ();
    type BeforeAssetTransfer = RioSavingTest;
...
pub fn new_test_ext() -> runtime_io::TestExternalities {
    ...
    rio_assets::GenesisConfig::<TestRuntime> {
        symbols: vec![
            ...
            (RIO_ASSET_ID, "RIO".as_bytes().to_vec()),
        ],
    }
    .assimilate_storage(&mut t)
    .unwrap();

    rio_saving::GenesisConfig::<TestRuntime> {
        current_phase_id: 1,
        phase_infos: vec![
        ...
        profit_asset_id: RIO_ASSET_ID,
        profit_pool: PROFIT_POOL,
        reserved_mint_wallet: BOB,
        reserved_mint_asset_id: RIO_ASSET_ID,
    }
    .assimilate_storage(&mut t)
    .unwrap();
